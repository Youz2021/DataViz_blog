...
| 2  |Six area graphs are redundant –  It is not necessary to use six area graphs in this visualisation since the six area graphs have same coordinate axis and layouts.     | Only keep one graph to show values with same coordinate axis and layouts.  |
...
|4  |Multiple unit measurement of Y axis used in the graph –  unit measurement of Y axis may make reader be confused.   | Keep the unit measurement of both Y axis and X axis uniform.  |
