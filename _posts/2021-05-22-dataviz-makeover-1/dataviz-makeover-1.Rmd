...
Click 'Create calculated field' and input formula "[Trade_Values_Import]+[Trade_Values_Export]" to create a new field named [Total Trade Value]. 

![](img/create_new_field.png){width=35%}![](img/calculate_field.png){width=40%}

2. Create bar chart

Drag [Total Trade Value],[Period_import] and [Trade_Values_Import] to Columns and Rows respectively.
Click [Period_import] and select 'Year' type.
...
Drag [Period_Import] to colour,then the graph will be colored automatically. 

5. Rename axis

Edit the title x-axis to “Total Merchandise Trade Values” and the subtitle to  "Thousand Dollars".
