...
2. Merge credit card data and loyalty card data into a new dataframe to make up the missing transactions in credit card data since the data in credit card dataset is unconsistent with the data in loyalty card dataset.
