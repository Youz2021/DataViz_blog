...
gps_path_selected <- gps_path2 %>%
  filter(day %in% c(17),hour %in% c(19))
...
4. Some locations are just popular o weekdays, for example, Abila Airport and Carlyle Chemical Inc.
...
Also, it explains why some locations just had transactions on weekdays. These locations are business partners with GAStech, employee always went there for business on weekdays.
...
1. The GPS tracks can not comply with transactions very well. 
...
## Q3. Can you infer the owners of each credit card and loyalty card? What is your evidence? Where are there uncertainties in your method? Where are there uncertainties in the data?




## Q4. Given the data sources provided, identify potential informal or unofficial relationships among GASTech personnel.
