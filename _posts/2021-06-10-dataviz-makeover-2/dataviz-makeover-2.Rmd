...
* Malaysia is a net exporter in 2011 while it becomes a net importer in 2020 for Singapore's merchandise trade. As shown below.

![](img/malaysia-2011.png){width=30%}   ![](img/malaysia-2020.png){width=30%}

The value of import exceeds export for Singapore's merchandise trade with Malaysia around 2018, then Malaysia becomes to net importer after 2019.

![](img/malaysia-trend.png){width=50%}
