...
Change the name of 'Variables - Split 1' to 'Markets - Import' by clicking the name of this column.
...
Change 'Pivot Field Names' and 'Pivot Field Values' column to 'Period - Import' and 'Values - Import' respectively by double click the column name.
...
Change the data type for the 'Period - Import' column to 'date' by clicking the data type icon on th right top of the column and select 'date'.

Chang the data type for the 'Values - Import' column to 'Numbers'  by clicking the data type icon on th right top of the column and select 'Numbers(decimal)'.
...
11. Build Relationship Between Tables

Build relationship between import data and export data by double click the link and add the column name we wanted to be related.

![](img/relation.png){width=40%}


### 4.2 Data visualisation

**Visualisation for Bubble Chart**

1.1. Drag data into canvas

Drag [Values-Export] and [Values-Import] to Columns and Rows respectively. Then change the measure of [Values-Export] and [Values-Import] to 'SUM'.

![](img/drag_export.png){width=50%}


1.2 Change Axis value to Percentage

Change Y-axis and X-axis to percentage by clicking Analysis and selecting Percentage of - Table.

![](img/percentage.png){width=50%}

1.3 Apply Detail 

Drag [Markets-Export] to Detail,then the chart would show the detail for each Market.

![](img/detail.png){width=60%}
